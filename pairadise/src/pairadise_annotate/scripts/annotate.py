...
if (sys.argv[1] == '-h' or sys.argv[1] == '--help'):
  print ('usage: pairadise_annotate [gtfFile] [outputPrefix] [SAMfiles] [libType] [logFolder]\n');
  print('pairadise2: annotate\n')
  print('optional arguments:')
  print('-h, --help\tshow this help message and exit')
  print('[gtfFile]\tGTF annotation file (required)')
  print('[outputPrefix]\toutput directory (required)')
  print('[SAMfiles]\ta list of SAM files, seperated by comma (required)')
  print('[libType]\teither "fr-unstranded" or "fr-stranded" (required)')
  print('[logFolder]\tthe log directory (optional)')
  exit()
if (len(sys.argv)<5):
